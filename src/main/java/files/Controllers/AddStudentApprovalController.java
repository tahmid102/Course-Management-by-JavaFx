...
public class AddStudentApprovalController {
    ...
    private final String PENDING_FILE = "/database/PendingStudentCredentials.txt";
    private final String STUDENT_FILE = "src/main/resources/database/StudentCredentials.txt"; // for writing
    ...
    private void approveStudent(Student student) {
        // Append to permanent student file
